          ...
          <CardContent className="pt-6">
            <form action={submitQuestion} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="image" name="image" type="file" accept="image/*" className="bg-background/50 border-white/10 focus-visible:ring-primary file:text-primary file:bg-primary/10 file:border-0 file:ml-4 file:py-2 file:px-4 file:rounded-md cursor-pointer" />
              </div>
